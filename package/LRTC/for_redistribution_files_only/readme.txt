...
2. Installing the LRTC Package

A. Change to the directory that contains the file setup.py and the subdirectory LRTC. If 
...
3. Using the LRTC Package

The LRTC package is on your Python path. To import it into a Python script or session, 
execute:
