...
2. Installing the STDC Package

A. Change to the directory that contains the file setup.py and the subdirectory STDC. If 
...
3. Using the STDC Package

The STDC package is on your Python path. To import it into a Python script or session, 
execute:
